...
namespace Atomic.Atomic
{
	...
	{
		// Token: 0x0600004A RID: 74 RVA: 0x00006034 File Offset: 0x00004234
		...
		// Token: 0x0600004B RID: 75 RVA: 0x000062C8 File Offset: 0x000044C8
		public static void Mutate1(MethodDef method)
		{
			...
			for (int j = 0; j < method.Body.Instructions.Count; j++)
			{
				...
				if (flag2)
				{
					...
					{
					case 1:
						typeDefOrRef = method.Module.Import(typeof(int));
						num2 = 4;
						break;
					case 2:
						typeDefOrRef = method.Module.Import(typeof(sbyte));
						num2 = 1;
						break;
					case 3:
						typeDefOrRef = method.Module.Import(typeof(byte));
						num2 = 1;
						break;
					case 4:
						typeDefOrRef = method.Module.Import(typeof(bool));
						num2 = 1;
						break;
					case 5:
						typeDefOrRef = method.Module.Import(typeof(decimal));
						num2 = 16;
						break;
					case 6:
						typeDefOrRef = method.Module.Import(typeof(short));
						num2 = 2;
						break;
					case 7:
						typeDefOrRef = method.Module.Import(typeof(long));
						num2 = 8;
						break;
					case 8:
						typeDefOrRef = method.Module.Import(typeof(uint));
						num2 = 4;
						break;
					case 9:
						typeDefOrRef = method.Module.Import(typeof(float));
						num2 = 4;
						break;
					case 10:
						typeDefOrRef = method.Module.Import(typeof(char));
						num2 = 2;
						break;
					case 11:
						typeDefOrRef = method.Module.Import(typeof(ushort));
						num2 = 2;
						break;
					case 12:
						typeDefOrRef = method.Module.Import(typeof(double));
						num2 = 8;
						break;
					case 13:
						typeDefOrRef = method.Module.Import(typeof(DateTime));
						num2 = 8;
						break;
					case 14:
						typeDefOrRef = method.Module.Import(typeof(ConsoleKeyInfo));
						num2 = 12;
						break;
					case 15:
						typeDefOrRef = method.Module.Import(typeof(Guid));
						num2 = 16;
						break;
					}
					...
					{
					case 1:
						method.Body.Instructions.Insert(j + 1, Instruction.Create(OpCodes.Sizeof, typeDefOrRef));
